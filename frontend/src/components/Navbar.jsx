            ...
            {menuItems.map((item) => (
              <Link
                ...
                style={{
                  ...
                  backgroundColor: location.pathname === item.path ? 'rgba(102, 126, 234, 0.15)' : 'transparent',
                  textDecoration: 'none',
                  fontWeight: location.pathname === item.path ? '700' : '500',
                  border: location.pathname === item.path ? '1px solid rgba(102, 126, 234, 0.4)' : '1px solid transparent',
                  transition: 'all 0.3s ease',
                  position: 'relative',
                  overflow: 'hidden'
                }}
            ...
            {menuItems.map((item) => (
              <Link
                ...
                style={{
                  ...
                  padding: '14px 16px',
                  borderRadius: '12px',
                  color: location.pathname === item.path ? '#667eea' : 'rgba(255, 255, 255, 0.9)',
                  backgroundColor: location.pathname === item.path ? 'rgba(102, 126, 234, 0.15)' : 'transparent',
                  textDecoration: 'none',
                  fontWeight: location.pathname === item.path ? '700' : '500',
                  border: location.pathname === item.path ? '1px solid rgba(102, 126, 234, 0.4)' : '1px solid transparent',
